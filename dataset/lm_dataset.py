...
class DPODataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        chosen_input_ids = chosen_encoding['input_ids'] # 获取tokenize后的input_ids，并截断到最大长度
        chosen_loss_mask = self.generate_loss_mask(chosen_input_ids) # 为chosen生成loss mask，标记出需要计算loss的位置
